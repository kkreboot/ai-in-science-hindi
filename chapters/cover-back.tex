...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[text width=13.0cm, align=justify, text=white, font=\cvBH\fontsize{10.5}{14.5}\selectfont] 
    ...
    डेटा विश्लेषण, वैज्ञानिक अनुसंधान, स्वास्थ्य विज्ञान, अंतरिक्ष अन्वेषण, पर्यावरण अध्ययन
  ...
  \begin{scope}
    ...
    \node at ($(C)+(-5.8, 0.1)$) {\includegraphics[width=2.5cm]{images/author.jpg}};
  \end{scope}
  ...
  \node[draw=cvNeonCyan, line width=1.2pt, fill=white, inner sep=1.5pt, rounded corners=2pt] 
        (linkedin) at ($(C)+(-4.5, -4.5)$) {\includegraphics[width=2.1cm]{images/Linkedin.png}};
  \node[draw=cvNeonCyan, line width=1.2pt, fill=white, inner sep=1.5pt, rounded corners=2pt] 
        (instagram) at ($(C)+(0, -4.5)$) {\includegraphics[width=2.1cm]{images/Instagram.png}};
  \node[draw=cvNeonCyan, line width=1.2pt, fill=white, inner sep=1.5pt, rounded corners=2pt] 
        (github) at ($(C)+(4.5, -4.5)$) {\includegraphics[width=2.1cm]{images/github.png}};
  ...
  \node[anchor=east] at ($(C)+(8.5, -12.8)$) {
    \fcolorbox{cvNeonCyan}{white}{\includegraphics[height=1.5cm]{images/isbn-barcode.pdf}}
  };
  \node[anchor=east, text=white, font=\cvHH\fontsize{8.5}{10}\selectfont] 
        at ($(C)+(8.5, -13.9)$) {ISBN 978-93-5300-000-4};
