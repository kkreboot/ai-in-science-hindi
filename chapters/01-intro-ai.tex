  ...
  \foreach \x/\yr/\lbl/\dir in {%
     ...
     \ifnum\dir>0
       ...
       \node[anchor=south, align=center, text width=2cm, text=cvBlue] at (\x,0.32)
         {\cvHL\scriptsize\textbf{\yr}\\[-1pt]{\color{aigrey}\lbl}};
     \else
       \draw[cvGridColor!60!cvBlue, line width=0.6pt] (\x,0) -- (\x,-0.32);
...
विद्यार्थी अक्सर AI और \term{मशीन लर्निंग}{Machine Learning, ML} को एक ही समझ लेते हैं।
...
मशीन को बहुत सारे \term{डेटा}{data} दिखाए जाते हैं और वह स्वयं नियम \emph{सीख} लेती है।
...
आधुनिक विज्ञान में डेटा की मात्रा इतनी विशाल हो गई है कि उसे केवल मनुष्य द्वारा
...
\caption[गूगल टीचेबल मशीन इंटरफ़ेस]{गूगल टीचेबल मशीन (Google Teachable Machine) का इंटरफ़ेस -- जहाँ वेबकैम डेटा द्वारा मॉडल को प्रशिक्षित किया जा रहा है।}
\label{fig:teachable-machine-ui}
\end{figure}

\section{AI के प्रकार (एक झलक)}
\begin{itemize}[leftmargin=1.4em]
  \item \term{सँकरी AI}{Narrow AI} - केवल एक कार्य में निपुण (जैसे चेहरा पहचानना)।
        आज की लगभग सारी AI इसी प्रकार की है।
  \item \term{सामान्य AI}{General AI} - मनुष्य जैसी सर्व-कार्य बुद्धि। यह अभी
        केवल अनुसन्धान (research) का विषय है।
\end{itemize}

\section{जनरेटिव AI एवं भाषा मॉडल (Generative AI \& LLMs)}
...
इनके मूल में \term{वृहत् भाषा मॉडल}{Large Language Model, LLM} होते हैं -- ऐसे
...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item Machine Learning, AI का वह भाग है जिसमें मशीन डेटा से नियम स्वयं सीखती है।
  \item विशाल डेटा के विश्लेषण में AI आधुनिक विज्ञान का शक्तिशाली उपकरण है।
...
\begin{enumerate}[leftmargin=1.6em]
  \item \rule{2.5cm}{0.4pt}, AI का वह भाग है जिसमें मशीन डेटा से सीखती है।
...
\begin{mcq}
  ...
  \item आज की अधिकांश AI किस प्रकार की है?
    \begin{choices}
      \item सामान्य AI (General AI) \item सँकरी AI (Narrow AI)
...
\textbf{सँकरी AI (Narrow AI)}, \textbf{सामान्य AI (General AI)},
\textbf{प्रत्यक्षण/अधिगम/तर्क/निर्णय}, \textbf{जनरेटिव AI (Generative AI)},
\textbf{वृहत् भाषा मॉडल (LLM)}, \textbf{Transformer}, \textbf{मतिभ्रम (Hallucination)}।
\end{mukhyashabd}
\selfcheckqr{https://forms.gle/aivigyan-ch1-quiz}
