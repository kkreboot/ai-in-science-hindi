...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item मापन (measurement), त्रुटि (error) एवं डेटा के बीच सम्बन्ध।
  \item वक्र-संयोजन (curve fitting) एवं \term{समाश्रयण}{regression} द्वारा डेटा से
        नियम (law) खोजना - जो भौतिकी में ML का हृदय है।
  \item कण भौतिकी (particle physics) एवं खगोल विज्ञान में पैटर्न-पहचान।
  \item मोबाइल सेंसर एवं Python की सहायता से वास्तविक डेटा पर AI का प्रयोग।
\end{itemize}

\section{भौतिकी एक डेटा-विज्ञान है}

प्रत्येक भौतिक प्रयोग में हम कोई न कोई राशि मापते हैं - समय, दूरी, ताप, वोल्टता या
बल। ये सभी मान मिलकर \term{डेटा}{data} बनाते हैं। भौतिकी का मूल कार्य इन्हीं मानों में
छिपे \term{पैटर्न}{pattern} खोजकर एक \term{नियम}{law} तक पहुँचना है।

उदाहरण के लिए, गैलीलियो ने झुके हुए तल (inclined plane) पर लुढ़कती गेंद के समय एवं
दूरी के अनेक मान लिए, और उनमें यह पैटर्न पहचाना कि $s \propto t^2$। यह ठीक वही कार्य है
जो आज एक Machine Learning मॉडल करता है - \emph{डेटा से नियम सीखना}। अंतर केवल इतना है कि
गैलीलियो ने यह स्वयं किया, जबकि अब विशाल डेटा पर यह कार्य मशीन तेज़ी से कर देती है।

\begin{jante}
सन् 2017 में खगोलविदों ने Google की एक \emph{neural network} की सहायता से NASA की
Kepler दूरबीन के पुराने डेटा में दो नए ग्रह (\emph{exoplanets} - Kepler-90i तथा
Kepler-80g) खोजे, जिन्हें मनुष्य पहले चूक गए थे। मशीन ने वही प्रकाश-वक्र (light curve)
देखे, पर बहुत महीन पैटर्न पकड़ लिया।
\end{jante}

\section{मापन, त्रुटि एवं डेटा}
...
AI के लिए यह बहुत महत्वपूर्ण है: यदि डेटा में बहुत अधिक यादृच्छिक त्रुटि है (अर्थात्
डेटा ``शोरयुक्त'' / \emph{noisy} है), तो मॉडल का पूर्वानुमान भी अनिश्चित होगा। इसीलिए
कहा जाता है - \emph{``अच्छा डेटा ही अच्छी भौतिकी एवं अच्छी AI की नींव है।''}
...
डेटा से बेहतर परिणाम'' के सिद्धांत से कैसे जुड़ता है?
\end{sochiye}

\section{डेटा से नियम: समाश्रयण (Regression)}
...
Regression} कहते हैं। यह Machine Learning का सबसे सरल एवं सबसे महत्वपूर्ण मॉडल है।
...
ध्यान दें - मॉडल ``नियम'' को पहले से नहीं जानता; वह केवल डेटा देखकर सर्वोत्तम $m$ एवं
$c$ निकालता है। यही ``डेटा से सीखना'' का सार है। चित्र~\ref{fig:regression} में बिखरे
...
\textbf{लक्ष्य:} बिना कंप्यूटर के यह अनुभव करना कि मॉडल सर्वोत्तम रेखा कैसे खोजता है।\\[4pt]
...
\section{भौतिकी डेटा पर Python (एक झलक)}

ऊपर की रेखा कंप्यूटर से खींचना बहुत सरल है। नीचे \emph{Google Colab} में चलने वाला एक
छोटा सा Python कोड है जो डेटा पर सर्वोत्तम रेखा निकाल देता है। (यहाँ इसे समझना पर्याप्त
...
\emph{CERN} के \term{वृहत् हैड्रॉन संघट्टक}{Large Hadron Collider, LHC} में प्रति सेकंड
...
भारतीय अंतरिक्ष अनुसंधान संगठन (ISRO) ने चंद्रयान-3 के 'प्रज्ञान रोवर' (Pragyan Rover) द्वारा भेजे गए चंद्र-सतह के चित्रों के विश्लेषण के लिए AI और कंप्यूटर विज़न (Computer Vision) का उपयोग किया। AI एल्गोरिदम रोवर के पथ में आने वाले गड्ढों (craters) और पत्थरों को स्वतः पहचानकर उसे सुरक्षित मार्ग पर बढ़ने में सहायता करते हैं। इसके अतिरिक्त, चंद्र-सतह के डिजिटल एलिवेशन मॉडल (Digital Elevation Models, DEM) बनाने में भी AI का महत्वपूर्ण योगदान रहा है।
\end{jante}

\begin{jante}
LHC प्रति सेकंड लगभग 1 \emph{petabyte} (दस लाख गीगाबाइट) डेटा बनाता है - इसे संभालना
...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item \textbf{मौसम:} तापमान, दाब एवं आर्द्रता के विशाल डेटा से AI मौसम का
        पूर्वानुमान (weather forecasting) करती है। आधुनिक मॉडल अब पारंपरिक भौतिक
        समीकरणों के साथ-साथ ML का भी उपयोग करते हैं।
\end{itemize}

\begin{jante}
\textbf{भारतीय योगदान: मानसून का सटीक पूर्वानुमान (Monsoon Prediction by IISc):}
भारतीय विज्ञान संस्थान (IISc), बेंगलुरु और भारतीय मौसम विज्ञान विभाग (IMD) के शोधकर्ता भारत में मानसून की वर्षा के अधिक सटीक पूर्वानुमान के लिए कृत्रिम बुद्धिमत्ता (AI) और मशीन लर्निंग (ML) मॉडल का उपयोग कर रहे हैं। मानसून एक अत्यंत जटिल प्रणाली है जिसमें समुद्र के तापमान, हवा की दिशा और वायुमंडलीय दाब के बीच जटिल संबंध होते हैं। पारंपरिक सुपरकंप्यूटर भौतिक मॉडलों में जब Deep Learning को मिलाया जाता है, तो भारी वर्षा और अचानक आने वाली बाढ़ (flash floods) के पूर्वानुमान की सटीकता बहुत बढ़ जाती है।
\end{jante}

\begin{gatividhi}[मोबाइल सेंसर से वास्तविक भौतिक डेटा]
\textbf{लक्ष्य:} वास्तविक भौतिक डेटा एकत्र कर उसमें पैटर्न देखना।\\[4pt]
\textbf{सामग्री:} स्मार्टफ़ोन, मुफ़्त ``Phyphox'' ऐप।\\[4pt]
\textbf{चरण:}
\begin{enumerate}[leftmargin=1.6em]
  \item ``Phyphox'' इंस्टॉल करें और ``Acceleration (without g)'' प्रयोग चुनें।
  \item फ़ोन को हाथ में लेकर धीरे ऊपर-नीचे घुमाएँ; डेटा रिकॉर्ड करें।
  \item डेटा को CSV रूप में निर्यात (export) करें और ग्राफ़ देखें।
  \item बताएँ - किस क्षण त्वरण (acceleration) अधिकतम था? ग्राफ़ का आकार आवर्ती
        (periodic) है या नहीं?
\end{enumerate}
\textbf{विस्तार:} यही CSV डेटा Colab में खोलकर उस पर regression आज़माया जा सकता है।
\end{gatividhi}

\begin{figure}[h]
\centering
\includegraphics[width=0.48\linewidth]{images/phyphox_ui.jpg}
\caption[फिफॉक्स मोबाइल सेंसर इंटरफ़ेस]{स्मार्टफ़ोन में फिफॉक्स (Phyphox) ऐप का इंटरफ़ेस -- जहाँ त्वरण (acceleration) डेटा को मापा और ग्राफ़ के रूप में देखा जा सकता है।}
\label{fig:phyphox-ui}
\end{figure}

% ---------------- परियोजना ----------------
\begin{pariyojana}[लोलक का दोलन-काल - मापन से पूर्वानुमान]
\textbf{उद्देश्य:} डेटा से नियम सीखकर पूर्वानुमान करना, और उसे भौतिक सूत्र से जाँचना।\\[4pt]
...
\begin{enumerate}[leftmargin=1.6em]
  ...
  \item परिणाम की तुलना सूत्र $T = 2\pi\sqrt{L/g}$ से करें तथा ग्राफ़ की ढलान से
        $g$ का मान निकालें।
\end{enumerate}
\textbf{मूल्यांकन:} डेटा की शुद्धता, ग्राफ़, पूर्वानुमान की त्रुटि एवं $g$ के मान की
...
से मिलने वाले विशाल खगोलीय डेटा के विश्लेषण एवं पैटर्न-पहचान में AI का उपयोग बढ़ रहा है।
\end{bharatai}

\section*{सारांश (Summary)}
\addcontentsline{toc}{section}{सारांश}
\begin{itemize}[leftmargin=1.4em]
  \item भौतिकी मूलतः मापन एवं डेटा पर आधारित विज्ञान है; नियम खोजना डेटा में पैटर्न
        खोजना ही है।
  \item हर मापन में त्रुटि रहती है; अधिक एवं स्वच्छ डेटा बेहतर परिणाम देता है।
  \item रैखिक समाश्रयण (linear regression) डेटा से नियम ``सीखने'' का सरलतम ML मॉडल है,
        जो least-squares द्वारा सर्वोत्तम रेखा खोजता है।
  \item कण भौतिकी, गुरुत्वीय तरंगों एवं खगोल में AI विशाल डेटा से दुर्लभ पैटर्न पहचानती है।
...
\begin{enumerate}[leftmargin=1.6em]
  \item डेटा में से सर्वोत्तम रेखा खोजने की ML विधि को \rule{2.8cm}{0.4pt} कहते हैं।
...
\begin{enumerate}[leftmargin=1.6em]
  \item स्प्रिंग वाली गतिविधि कीजिए और बताइए कि ढलान से स्प्रिंग नियतांक $k$ कैसे
        प्राप्त होता है।
  \item दिए गए डेटा - $x:(1,2,3,4)$ तथा $y:(2,4,6,8)$ - के लिए हाथ से $m$ एवं $c$
        ज्ञात कीजिए। यह कौन-सा भौतिक सम्बन्ध दर्शाता है?
  \item Phyphox से एकत्र अपने त्वरण-डेटा का ग्राफ़ बनाकर उसमें दिखने वाले पैटर्न का
        वर्णन कीजिए।
\end{enumerate}
...
\begin{mcq}
  ...
  \item डेटा से सर्वोत्तम रेखा निकालने की विधि कहलाती है:
...
\begin{mukhyashabd}
\textbf{डेटा (data)}, \textbf{पैटर्न}, \textbf{नियम (law)}, \textbf{त्रुटि (error)} --
...
\end{mukhyashabd}
\selfcheckqr{https://forms.gle/aivigyan-ch2-quiz}
