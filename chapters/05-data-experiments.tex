\chapter{डेटा, प्रयोग एवं AI उपकरण}
\label{ch:data}

\lakshyaheading
\begin{itemize}[leftmargin=1.4em]
  \item अच्छे डेटा (good data) के गुण - शुद्धता, विविधता एवं पर्याप्त मात्रा।
  \item डेटा-विज्ञान (data science) के पाँच चरण - संग्रह से निष्कर्ष तक।
  \item डेटा में \term{पक्षपात}{bias} को पहचानना एवं उससे बचना।
...
यदि भीतर डाला गया डेटा ख़राब है तो परिणाम भी ख़राब ही होगा। कोई भी AI उतनी ही अच्छी
होती है जितना उसका डेटा। इसीलिए वैज्ञानिक प्रयोग में डेटा का \emph{सावधानीपूर्वक संग्रह}
...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item \term{विविधता}{Diversity} - डेटा सभी प्रकार की स्थितियों को दर्शाता हो।
  \item \term{पर्याप्त मात्रा}{Sufficient quantity} - इतने उदाहरण हों कि पैटर्न
        स्पष्ट दिखे।
\end{itemize}

\section{डेटा-विज्ञान के पाँच चरण}

किसी भी जाँच में - चाहे भौतिकी की हो, रसायन की या जीव विज्ञान की - डेटा के साथ कार्य
प्रायः इन्हीं पाँच चरणों में होता है:

\begin{enumerate}[leftmargin=1.8em]
  \item \term{संग्रह}{Collection} - सेंसर, सर्वेक्षण या प्रयोग से डेटा एकत्र करना।
  \item \term{सफ़ाई}{Cleaning} - त्रुटियाँ, दोहराव एवं रिक्त (missing) मान हटाना।
  \item \term{विश्लेषण}{Analysis} - ग्राफ़ एवं सांख्यिकी (statistics) से पैटर्न देखना।
  \item \term{मॉडलन}{Modelling} - पैटर्न से नियम/पूर्वानुमान निकालना (जैसे regression)।
...
\begin{jante}
डेटा वैज्ञानिक (data scientists) प्रायः अपना 60-80\% समय केवल \emph{चरण~2 (cleaning)}
में लगाते हैं। असली कौशल अक्सर ``साफ़ डेटा'' बनाने में ही होता है, न कि केवल मॉडल चलाने में।
\end{jante}

\section{डेटा में पक्षपात (Bias)}

यदि एकत्र किया गया डेटा एकपक्षीय हो, तो AI के परिणाम भी \term{पक्षपाती}{biased} होंगे -
भले ही कोड बिल्कुल सही हो। उदाहरण के लिए, यदि किसी पत्ती-पहचान मॉडल को केवल हरी पत्तियों
के चित्र दिए जाएँ, तो वह सूखी या पीली पत्ती पहचानने में असफल रहेगा।

इसीलिए वैज्ञानिक कार्य में यह सदैव पूछा जाता है - ``क्या मेरा डेटा सभी स्थितियों का
...
\href{https://phyphox.org/}{Phyphox}           & मोबाइल सेंसर से भौतिक डेटा एकत्र करना \\
...
\begin{gatividhi}[Colab में पहला कदम - डेटा का ग्राफ़ एवं regression]
\textbf{लक्ष्य:} स्वयं Python चलाकर डेटा पर सर्वोत्तम रेखा खींचना।\\[4pt]
...
\begin{gatividhi}[कक्षा का डेटा - सहसम्बन्ध (correlation)]
\textbf{लक्ष्य:} वास्तविक डेटा एकत्र कर उसमें सम्बन्ध खोजना।\\[4pt]
\textbf{चरण:}
\begin{enumerate}[leftmargin=1.6em]
...
\textbf{उद्देश्य:} किसी एक प्रश्न पर स्वयं डेटा एकत्र कर पाँचों चरणों का पालन करना।\\[4pt]
...
\begin{enumerate}[leftmargin=1.6em]
  ...
  \item \textbf{विश्लेषण:} डेटा का ग्राफ़ बनाएँ (कागज़ या Colab)।
  ...
  \item \textbf{निष्कर्ष:} परिणाम को 5 स्लाइड या एक पोस्टर के रूप में प्रस्तुत करें,
        और डेटा की किन्हीं सीमाओं (limitations) का उल्लेख करें।
\end{enumerate}
\textbf{मूल्यांकन:} पाँचों चरणों के पालन, डेटा की गुणवत्ता एवं निष्कर्ष की स्पष्टता
के आधार पर।
\end{pariyojana}
...
\begin{itemize}[leftmargin=1.4em]
  \item अच्छा डेटा (शुद्ध, विविध एवं पर्याप्त) ही अच्छी AI की नींव है -
        ``garbage in, garbage out''।
  \item डेटा-विज्ञान के पाँच चरण हैं: संग्रह, सफ़ाई, विश्लेषण, मॉडलन एवं निष्कर्ष।
  \item एकपक्षीय डेटा से पक्षपाती (biased) परिणाम मिलते हैं, चाहे कोड सही हो।
  \item Teachable Machine, Google Colab, Phyphox एवं Orange जैसे मुफ़्त उपकरणों से
        विद्यार्थी स्वयं AI का अनुभव कर सकते हैं।
  \item Google Colab में कुछ ही पंक्तियों के Python से डेटा का ग्राफ़ एवं regression
        किया जा सकता है।
\end{itemize}
...
\begin{enumerate}[leftmargin=1.6em]
  \item ``Garbage in, \rule{2.8cm}{0.4pt} out'' - ख़राब डेटा से ख़राब परिणाम।
...
\textbf{ब. लघु उत्तरीय:}
\begin{enumerate}[leftmargin=1.6em]
  \item अच्छे डेटा के तीन गुण लिखिए।
...
\begin{enumerate}[leftmargin=1.6em]
  ...
  \item कक्षा के height बनाम arm-span डेटा का scatter-plot बनाइए और सम्बन्ध का वर्णन कीजिए।
  \item किसी एक प्रश्न पर सप्ताह-भर डेटा एकत्र कर पाँचों चरणों की एक संक्षिप्त रिपोर्ट
        बनाइए।
\end{enumerate}

\begin{mcq}
  \item ``Garbage in, garbage out'' का अर्थ है:
    \begin{choices}\item तेज़ कंप्यूटर \item ख़राब डेटा से ख़राब परिणाम
      \item मुफ़्त सॉफ़्टवेयर \item बड़ा मॉडल\end{choices}
