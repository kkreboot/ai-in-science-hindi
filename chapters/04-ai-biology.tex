...
\begin{itemize}[leftmargin=1.4em]
  \item जीवन की जानकारी को \emph{data} के रूप में समझना - विशेषकर DNA एवं प्रोटीन।
  ...
  \item मुफ़्त उपकरणों एवं सरल Python से जैविक data पर स्वयं प्रयोग।
\end{itemize}

\section{जीवन का data: DNA}
...
3 अरब (3 billion) अक्षर होते हैं। यह इतना विशाल \eterm{data} है कि इसका विश्लेषण
AI के बिना लगभग असम्भव है।

इन अक्षरों के क्रम (sequence) में ही यह छिपा होता है कि कौन-सा प्रोटीन बनेगा और कोशिका
कैसे कार्य करेगी। AI इन क्रमों में pattern खोजकर बता सकती है कि कोई विशेष क्रम किसी रोग
से जुड़ा है या नहीं - इसी क्षेत्र को \eterm{Bioinformatics} कहते हैं।
...
G, C क्षारकों का क्रम ही जीवन का विशाल “data” है, जिसे AI पढ़ती एवं विश्लेषित करती
...
\begin{enumerate}[leftmargin=1.6em]
  ...
  \item model “Train” करें, फिर एक नई पत्ती दिखाकर परिणाम देखें।
...
\section{जैविक data पर Python (एक झलक)}
...
(biodiversity) का data एकत्र कर सकते हैं।

\begin{jante}
\emph{iNaturalist} एवं इसी प्रकार के ऐप करोड़ों तस्वीरों पर प्रशिक्षित हैं। जब आप कोई
तस्वीर डालते हैं, तो AI तुरंत सम्भावित प्रजातियों के नाम सुझा देती है - और यह data
...
data एकत्र करना और उसकी सीमाएँ समझना।\\[4pt]
...
\begin{enumerate}[leftmargin=1.6em]
  ...
  \item निष्कर्ष लिखें - स्थानीय data की कमी model की सटीकता को कैसे प्रभावित करती है?
\end{enumerate}
\textbf{मूल्यांकन:} एकत्र data की विविधता, सत्यापन की गंभीरता एवं निष्कर्ष की
स्पष्टता के आधार पर।
\end{pariyojana}
...
\begin{itemize}[leftmargin=1.4em]
  \item जीवन की जानकारी DNA में चार क्षारकों (A, T, G, C) के क्रम के रूप में एक विशाल
        data है, जिसका विश्लेषण Bioinformatics में AI द्वारा होता है।
  ...
  \item DNA जैसे data पर सरल Python से ही जैविक विश्लेषण आरम्भ किया जा सकता है।
\end{itemize}
...
\begin{enumerate}[leftmargin=1.6em]
  ...
  \item प्रोटीन की 3D संरचना के पूर्वानुमान करने वाली प्रसिद्ध AI का नाम
        \rule{2.8cm}{0.4pt} है।
  \item जैविक data के विश्लेषण के क्षेत्र को \rule{2.8cm}{0.4pt} कहते हैं।
\end{enumerate}

\textbf{ब. लघु उत्तरीय:}
\begin{enumerate}[leftmargin=1.6em]
  \item “DNA एक data है” - इस कथन को समझाइए।
...
\begin{mcq}
  ...
  \item DNA क्रमों में pattern खोजने वाला क्षेत्र कहलाता है:
...
\textbf{GC content}।
\end{mukhyashabd}
\selfcheckqr{https://kkreboot.github.io/ai-in-science-hindi/quiz/ch4.html}
