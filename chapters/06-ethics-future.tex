...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item डेटा में पक्षपात (bias) एवं निजता (privacy) की समस्याएँ।
...
डेटा से सिखाया गया है। इसी कारण AI कभी-कभी पूरे आत्मविश्वास के साथ \emph{ग़लत} उत्तर भी
...
अध्याय~5 में हमने देखा कि एकपक्षीय डेटा से पक्षपाती परिणाम मिलते हैं। यह केवल तकनीकी
समस्या नहीं, बल्कि एक \emph{नैतिक} समस्या भी है, क्योंकि पक्षपाती AI किसी वर्ग के साथ
अन्याय कर सकती है।

\begin{sochiye}
यदि किसी रोग-निदान AI को केवल एक ही आयु-वर्ग के रोगियों का डेटा दिया जाए, तो वह अन्य
...
विज्ञान, विशेषकर चिकित्सा एवं जीव विज्ञान में, अक्सर व्यक्तिगत डेटा (जैसे चिकित्सा-रिकॉर्ड
या DNA) का उपयोग होता है। ऐसे डेटा की \term{निजता}{privacy} एवं सुरक्षा बनाए रखना
वैज्ञानिक का नैतिक उत्तरदायित्व है। डेटा का उपयोग केवल अनुमति (consent) से एवं निर्धारित
...
\begin{itemize}[leftmargin=1.4em]
  ...
  \item \term{निजता}{Privacy} - व्यक्तिगत डेटा सुरक्षित रहे।
\end{itemize}
...
\begin{enumerate}[leftmargin=1.6em]
  \item पिछले अध्यायों में बनाए किसी मॉडल (जैसे Teachable Machine का पत्ती-वर्गीकरण)
        को जानबूझकर कठिन उदाहरण दिखाएँ - जैसे कम रोशनी, उलटी या आधी ढकी वस्तु।
  \item नोट करें कि किन स्थितियों में मॉडल ग़लत या अनिश्चित (uncertain) हुआ।
  \item विचार करें - क्या इसका कारण डेटा की कमी या पक्षपात था?
\end{enumerate}
...
\begin{itemize}[leftmargin=1.4em]
  \item \term{जैव-सूचना विज्ञान}{Bioinformatics} - जीव विज्ञान एवं डेटा का मेल।
  \item \term{संगणनात्मक भौतिकी}{Computational Physics} - प्रयोग एवं सिमुलेशन।
  \item \term{डेटा विज्ञान}{Data Science} - हर क्षेत्र में डेटा से निर्णय।
...
जहाँ AI विशाल डेटा संभालेगी और मनुष्य कल्पना, प्रश्न एवं नैतिक निर्णय देगा।
\end{jante}
...
\begin{enumerate}[leftmargin=1.6em]
  \item किसी मॉडल को कठिन उदाहरण दिखाकर उसकी सीमाएँ खोजने वाली गतिविधि कीजिए और
        अपने अवलोकन लिखिए।
...
\begin{mcq}
  ...
  \item विज्ञान में अंतिम निर्णय किसके पास रहना चाहिए?
    \begin{choices}\item AI मॉडल \item मनुष्य (वैज्ञानिक)
...
\end{mukhyashabd}
\selfcheckqr{https://forms.gle/aivigyan-ch6-quiz}
...
\emph{डेटा} है। भौतिकी में पैटर्न, रसायन में अणु, और जीव विज्ञान में DNA - सभी को AI
डेटा के रूप में ``पढ़'' सकती है।
