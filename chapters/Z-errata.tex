...
\begin{minipage}[c]{0.74\linewidth}
  \textbf{ईमेल:} \texttt{kkgodara2000@gmail.com}\\[3pt]
  \textbf{प्रतिक्रिया फ़ॉर्म:} \nolinkurl{forms.gle/ai-vigyan-feedback}\\[2pt]
  {\footnotesize\color{aigrey}(दाईं ओर QR स्कैन कर सीधे ईमेल/फ़ॉर्म खोलें)}
\end{minipage}\hfill
...
\vspace{6pt}
\noindent{\footnotesize\color{aigrey}\emph{नोट:} ऊपर दिया फ़ॉर्म-लिंक एक नमूना
(placeholder) है; प्रकाशन से पूर्व इसे वास्तविक लिंक से बदलें।}
