...
\begin{itemize}[leftmargin=1.4em]
  \item अणु (molecule) एवं अभिक्रिया (reaction) को \emph{डेटा} के रूप में देखना।
  \item आवर्त सारणी (periodic table) के गुणों में पैटर्न एवं प्रवृत्ति (trend) पहचानना।
  ...
  \item मुफ़्त उपकरणों से अणु एवं डेटा पर स्वयं प्रयोग करना।
\end{itemize}

\section{अणु भी एक डेटा हैं}
...
एक प्रचलित तरीका है \term{स्माइल्स संकेतन}{SMILES notation}, जिसमें अणु को एक छोटी
...
किसी अणु की त्रि-आयामी (3D) संरचना भी डेटा ही है, जैसा चित्र~\ref{fig:caffeine} में
कैफ़ीन (caffeine) अणु के लिए दिखाया गया है।

\begin{figure}[h]
\centering
\includegraphics[width=0.45\linewidth]{images/caffeine.png}
\caption[कैफ़ीन अणु का त्रि-आयामी मॉडल]{कैफ़ीन अणु का त्रि-आयामी (ball-and-stick) मॉडल --
परमाणु एवं बंध ही वह ``डेटा'' हैं जिन्हें AI पढ़ती है।\imgsrc{Wikimedia Commons (Public Domain)}}
\label{fig:caffeine}
\end{figure}
...
\section{पैटर्न: आवर्त सारणी की भाषा}
...
जो बाद में सही निकले। यही ``डेटा से पूर्वानुमान'' का विचार आज ML करता है।
...
\bottomrule
\end{tabular}
\caption{आवर्त सारणी में दिखने वाली नियमित प्रवृत्तियाँ - पैटर्न का आधार}
\end{table}
...
\textbf{लक्ष्य:} डेटा में रुझान पहचानकर एक अनदेखे मान का पूर्वानुमान करना।\\[4pt]
...
\end{enumerate}
\textbf{अवलोकन:} आपने वही किया जो एक ML ``regression'' मॉडल करता है - ज्ञात बिंदुओं से
...
\caption[एस्पिरिन अणु का 3D मॉडल]{एस्पिरिन (aspirin) अणु का 3D मॉडल -- AI ऐसे हज़ारों
दवा-अणुओं की संरचना एवं गुणों की तुलना कर सम्भावित औषधियाँ छाँटती है।\imgsrc{Wikimedia Commons (Public Domain)}}
\label{fig:aspirin}
\end{figure}

\begin{jante}
सन् 2020 में MIT के शोधकर्ताओं ने एक AI मॉडल से \emph{Halicin} नामक नया एंटीबायोटिक
...
\section{रसायन डेटा पर Python (एक झलक)}

नीचे का छोटा कोड दिखाता है कि किसी सरल डेटा (ताप बनाम विलेयता) पर मशीन सर्वोत्तम वक्र
...
\noindent यहाँ मॉडल किसी रासायनिक सूत्र को नहीं जानता - वह केवल डेटा से प्रवृत्ति सीखकर
मध्यवर्ती ताप पर विलेयता का पूर्वानुमान कर देता है।

\begin{gatividhi}[बिना कोड - अणुओं का दृश्य अन्वेषण]
\textbf{लक्ष्य:} अणु को त्रि-आयामी (3D) संरचना के रूप में ``डेटा'' की तरह देखना।\\[4pt]
...
\begin{enumerate}[leftmargin=1.6em]
  ...
  \item SMILES संकेत (जैसे एथेनॉल = \texttt{CCO}) नोट करें - यही वह ``डेटा'' है जिसे
        AI पढ़ती है।
\end{enumerate}
\end{gatividhi}
...
\caption[मॉलव्यू आणविक दृश्य अन्वेषण]{मॉलव्यू (MolView) वेबसाइट का इंटरफ़ेस -- जहाँ बाईं ओर 2D संरचना और दाईं ओर कैफीन (Caffeine) अणु का 3D मॉडल (Ball-and-Stick) दर्शाया गया है।}
\label{fig:molview-ui}
\end{figure}

% ---------------- परियोजना ----------------
\begin{pariyojana}[विलेयता का पूर्वानुमान - प्रयोग से सत्यापन]
\textbf{उद्देश्य:} वास्तविक प्रयोग का डेटा एकत्र कर उससे पूर्वानुमान करना एवं उसे
...
\begin{enumerate}[leftmargin=1.6em]
  ...
  \item चर्चा करें - डेटा बिंदु बढ़ाने पर पूर्वानुमान बेहतर हुआ या नहीं?
\end{enumerate}
...
\end{mukhyashabd}
\selfcheckqr{https://forms.gle/aivigyan-ch3-quiz}
